...
compression_opts_g = dict(method='zip',archive_name='General_InspectionReports.csv')  
General_InspectionReports.to_csv('General_InspectionReports.zip', index=False, compression=compression_opts_g)
